                ...
                <a href="#" class="navbar-brand">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav text-center ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link ml-auto text-white" style="text-decoration: underline">{{Auth::guard('masyarakat')->user()->nama}}</a>
                            </li>
                        </ul>
                        ...
                        <ul class="navbar-nav text-center ml-auto">
                            <li class="nav-item">
                                <button class="btn text-white btn btn-warning" type="button" data-toggle="modal" data-target="#loginModal">
                                    Login
                                </button>
                            </li>

                            <li class="navbar-item">
                                <a href="{{ route('ereporthub.formRegister') }}" class="btn btn-outline-primary-purple">Register</a>
                            </li>
                        </ul>
...
<div class="row justify-content-center">
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            <div class="card text-white mb-3">Create Your Report Here</div>
            ...
            <form action="#" method="POST">
                ...
                <button type="submit" class="btn container text-center text-white btn-custom mt-2">Send</button>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">IDN Boarding School Solo</p>
    </div>
</div>
